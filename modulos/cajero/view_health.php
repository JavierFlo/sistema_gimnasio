				...
				<?php
					...
					if (mysqli_affected_rows($con) != 0) {
					    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
					     ...
					     $sno++;   
					        echo "<td><form action='edit_viewhealth.php' method='post'><input type='hidden' name='name' value='" . $msgid . "'/><input type='submit' value='Editar estado de salud' class='btn btn-info'/></form><form action='del_viewhealth.php' method='post' onSubmit='return ConfirmDelete();'><input type='hidden' name='name' value='" . $msgid . "'/><input type='submit' value='Eliminar estado de salud' class='btn btn-danger'/></form></td></tr>";
					        $msgid = 0;
					    }
