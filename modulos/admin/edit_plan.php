...
<head>
    ...
    <title>X-plode GYM  Administración </title>
			...
			?>
				...
				<div class="form-group">
					<label for="field-1" class="col-sm-3 control-label">Detalles :</label>					
						<div class="col-sm-5">
							<input type="text" name="details"  id="emailfield" class="form-control" value ='<?php echo $details; ?>'  data-rule-minlength="5" placeholder="Detalles" maxlength="999">
						</div>
				</div>
				...
				<div class="form-group">
					<label for="field-1" class="col-sm-3 control-label">Dias :</label>					
						<div class="col-sm-5">
							<input type="text" name="days" id="textfield4" class="form-control" data-rule-required="true" data-rule-minlength="1" placeholder="Dias" value ='<?php echo $days; ?>'  onKeyPress="return checkIt(event)" maxlength="3">
						</div>
				</div>										
				...
				<div class="form-group">
					<label for="field-1" class="col-sm-3 control-label">Tarifa :</label>					
						<div class="col-sm-5">
							<input type="text" name="rate" id="textfield6" class="form-control" data-rule-required="true" data-rule-minlength="10" placeholder="Tarifa" value ='<?php echo $rate; ?>'  onKeyPress="return checkIt(event)" maxlength="10">
						</div>
				</div>		
