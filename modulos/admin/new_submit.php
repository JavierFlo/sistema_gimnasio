    ...
    if (mysqli_affected_rows($con) == 1) {
        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
            ...
            $p_id = $row['newid'];
             ...
             mysqli_query($con, "UPDATE user_data SET name='$full_name', address='$address', birthdate='$birthdate', contact='$contact', email='$email', height='$height', weight='$weight', joining='$date', age='$age', proof='$proof', other_proof='$other_proof', sex='$sex' WHERE wait='yes'");
            $bal = $total - $paid;
...
?>";
	...
	<body>
		<header>
			...
			<address>
				<p>X-plode GYM </p>
        <p>Dirección: cristobal colon, 33620 Saucillo Chihuahua</p>
        <p>Celular:639-471-97-54</p><p>www.xplode-gym.com.mx</p><br><p><div id="barcodeTarget" class="barcodeTarget"></div>
            <canvas id="canvasTarget"></canvas> </span>
			</address>
			<span><img alt="" src="../../img/logofinal.png">
		</header>
		<article>
			<table class="meta">
			<tr>
...
?></span></td>
		...
		</aside><center><br><br><a href="view_mem.php">X-plode GYM ( www.xplode-gym.com.mx )</center>
	</body>
</html>