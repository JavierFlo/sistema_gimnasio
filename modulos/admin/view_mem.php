		...
		<table class="table table-bordered datatable" id="table-1">
			<thead>
				<tr>
					...
					<th>Altura / Peso</th>
					<th>Fecha de Inscripción / Membresia</th>
					<th>Accion</th>
				</tr>
			</thead>
				<tbody>
