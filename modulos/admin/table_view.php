						    ...
						    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
						        ...
						        if (mysqli_affected_rows($con) == 1) {
						            while ($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC)) {
						                ...
						                echo "<td><form action='new_member_table.php' method='post'><input type='hidden' name='name' value='" . $msgid . "'/><input type='hidden' name='full_name' value='" . $msgid1 . "'/><input type='submit' value='Nueva asistencia' class='btn btn-info'/></form><form action='view_member_table.php' method='post'><input type='hidden' name='name' value='" . $msgid . "'/><input type='hidden' name='full_name' value='" . $msgid1 . "'/><input type='submit' value='Ver asistencias' class='btn btn-warning'/></form></td></tr>";
						                $msgid = 0;
						            }
						        }
						    }
