		...
		<form action="submit_health_new.php" enctype="multipart/form-data" method="POST" role="form" class="form-horizontal form-groups-bordered">
			...
			<div class="form-group">
				<label for="field-1" class="col-sm-3 control-label">Porcentaje de Masa Muscular :</label>					
					<div class="col-sm-5">
						<input type="text" name="muscle" id="muscle" class="form-control" placeholder="Porcentaje de Masa Muscular" >
					</div>
			</div>
			...
			<div class="form-group">
				<label for="field-1" class="col-sm-3 control-label">>Numero de calorias diarias:</label>					
					<div class="col-sm-5">
						<input type="text" name="calorie" id="calorie" class="form-control" placeholder="Numero de calorias diarias" >
					</div>
			</div>
