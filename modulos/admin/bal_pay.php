		...
		<form action="bal_pay_submit.php" enctype="multipart/form-data" method="POST" role="form" class="form-horizontal form-groups-bordered">
			...
			<div class="form-group">
				<label for="field-1" class="col-sm-3 control-label">Pagado:</label>					
					<div class="col-sm-5">
						 <input type="text" name="paid" id="textfield6" class="form-control" data-rule-required="true" data-rule-minlength="10" placeholder="Pagado" value ='<?php echo $paid; ?>'  onKeyPress="return checkIt(event)" maxlength="10">
					</div>
			</div>
