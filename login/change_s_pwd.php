...
if (isset($user_id_auth) && isset($pass) && isset($key)) {
    ...
    if ($count == 1) {
        ...
        echo "<html><head><script>alert('Contraseña cambiada ,Logeate de nuevo ');</script></head></html>";
        echo "<meta http-equiv='refresh' content='0; url=index.php'>";
    } else {
        echo "<html><head><script>alert('Cambios NO guardados');</script></head></html>";
        echo "<meta http-equiv='refresh' content='0; url=index.php'>";
    }
} else {
    echo "<html><head><script>alert('Cambios guardados');</script></head></html>";
    echo "<meta http-equiv='refresh' content='0; url=index.php'>";
}
?>
<center>
